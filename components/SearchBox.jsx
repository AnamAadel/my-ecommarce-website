    ...
    <>
        ...
        <div className='w-[80%] sm:max-w-[400px] bg-sweet-yellow border p-4 space-y-1' onKeyUp={handleArrowKey}>
            ...
            {suggestions.map((item, ind)=> (
                <li className={`px-2 py-1 font-medium bg-white border text-[0.8rem] ${trackIndex == ind && "bg-stone-600 text-white"} hover:bg-stone-600 hover:text-white cursor-pointer`} onClick={()=> pickInputValue(item)}>{item}</li>
